...
export const Landingsection5 = () => {
  return (
    <>
      <main>
        <section className="h-full w-full bg-backgroundwhite mt-[250px] mb-[100px]">
          <div className="flex flex-col gap-3 xl:px-32 lg:p-5 ">
          ...
          <div className="xl:flex lg:flex lg:flex-col  items-center mt-32 ">
            <div className=" flex xl:ml-[-4px] lg:p-3 flex-col gap-16">
