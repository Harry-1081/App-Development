...
export const Landingsection4 = () => {
  return (
    <>
      <div class="box4 relative  gap-5 flex flex-col lg:flex-col items-center text-center mt-[300px]">
      ...
      <div class="flex relative lg:flex-col justify-evenly xl:h-[565.14px] lg:h-[1200.55px] items-center pl-[100px] pr-[100px]">
        <div class="box4-f1 xl:w-[350px] rounded-xl lg:w-[320px] h-[369.5px] bg-pink-100 p-4 text-center">
        ...
        <div class="box4-f2 xl:w-[350px] rounded-xl lg:w-[320px] h-[369.5px] bg-pink-100 p-4 text-center">
        ...
        <div class="box4-f3 xl:w-[350px] rounded-xl lg:w-[320px] h-[369.5px] bg-pink-100 p-4 text-center">
