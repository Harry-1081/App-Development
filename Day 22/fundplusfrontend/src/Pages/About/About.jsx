        ...
        {/* Division 1 */}
            <div className="flex xl:justify-evenly lg:flex-col xl:h-[720px] items-center">
                ...
                <div className="lg:pl-[5%] lg:h-[450px] lg:mt-[30px]">
                    ...
                    <p className="xl:hidden max-w-[450px] lg:text-[0.9rem] lg:pr-[5%]">At Fundpulse, our purpose is to foster a world where compassion knows
        ...
        {/* Division 2 */}
            <div className="flex-col items-center bg-[#396c61]">
                ...
                <div className="flex items-center xl:justify-evenly lg:flex-col lg:gap-y-[30px] xl:h-[635px] lg:h-[1260px]">
                    ...
                    <div className="xl:w-[335px] xl:h-[460px] bg-white rounded-[15px] lg:w-[270px] lg:h-[385px]
